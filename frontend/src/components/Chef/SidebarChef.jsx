...
const menuItems = [
    { path: "/chef/dashboard", label: "Dashboard", icon: LayoutDashboard },
    { path: "/chef/orders", label: "Đơn hàng", icon: BookOpenCheck },
    { path: "/chef/recipes", label: "Công thức", icon: ReceiptText },
    { path: "/chef/ingredients", label: "Nguyên liệu", icon: Users },
];
        ...
        <div className="flex items-center gap-3">
          ...
          {!collapsed && (
            <div className="transition-opacity duration-300">
              <h2 className="text-lg font-semibold text-gray-800">Đầu Bếp</h2>
              <p className="text-xs text-gray-500">Nhân viên đầu bếp</p>
            </div>
          )}
        </div>
