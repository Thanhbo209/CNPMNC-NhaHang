                          ...
                          >
                            ...
                            <div className="absolute top-1 right-1 flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                              <button
                                ...
                                className="p-1.5 rounded bg-yellow-100 hover:bg-yellow-200 text-yellow-600 transition-all duration-200 hover:shadow-md"
                              >
                                <Pen size={14} />
                              </button>
                              <button
                                ...
                                className="p-1.5 rounded bg-red-100 hover:bg-red-200 text-red-600 transition-all duration-200 hover:shadow-md"
                              >
                                <Trash2 size={14} />
                              </button>
                            </div>
